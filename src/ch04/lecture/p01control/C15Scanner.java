...
public class C15Scanner {
	public static void main(String[] args) {
		...
		//scanner 기본구분자: 공백
		String t1 = scanner.next(); //첫번째 토큰 끊어짐
...
//		System.out.println(t4 * 2); //x
		...
		int i1 = Integer.valueOf(t4); //int 연산을 하기 위해 바꿈
		...
		String line1 = scanner.nextLine(); //새로운 줄이 나올 때까지 출력
		...
		scanner = new Scanner(System.in); //키보드
		...
		System.out.println("입력한 한줄: " + input3); //끝의 엔터를 만나서 빈스트링이 나옴, 앞에 한 줄 추가하기
